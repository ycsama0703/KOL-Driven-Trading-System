...
from tools.index import (get_format_results, get_stock_symbols)
...
def get_agent_system_prompt(
    ...
    # today_init_position = {"AAPL": 0.3, "TSLA": 0.4, "CASH": 0.3}

    cash = today_init_position.pop("CASH", 0)  # 如果不存在"CASH"，默认为0

    # yesterday_profit = get_yesterday_profit(today_date, yesterday_buy_prices, yesterday_sell_prices, today_init_position)
    
    market_state = get_format_results(today_date, stock_symbols, merged_data_path="/home/yuan/AI-Trader/data/merged.jsonl")
...
if __name__ == "__main__":
    ...
    # get_agent_system_prompt(today_date, signature)
